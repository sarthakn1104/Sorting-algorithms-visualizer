...
public class Visualizer extends JFrame implements ActionListener {
	...
	public static final int HEIGHT = 2300;
	...
	public Visualizer() throws InterruptedException {
		...
		title.setBounds(400, 20, titleSize.width + 545, titleSize.height + 65);
		title.setFont(new Font("Panton", Font.BOLD, 44));
		
		name = new JLabel("Developed by: Sarthak Shirish Nakhate");
		name.setForeground(Color.WHITE);
		name.setBounds(480, 100, 545, 65);
